		...
		<view class="box">
			...
			<view class="cu-bar tabbar bg-white shadow foot">
				...
				<view class="action" @click="NavChange" data-cur="discuss">
					<view class='cuIcon-cu-image'>
						<image v-if="PageCur=='discuss'" src="../../static/tabBar/shop_cur.png"></image>
						<image v-if="PageCur != 'discuss'" src="../../static/tabBar/shop.png"></image>
					</view>
					<view :class="PageCur=='discuss'?'color_main':'text-gray'">校内吐槽</view>
				</view>
				...
				<view class="action" @click="NavChange" data-cur="news">
					...
					<view :class="PageCur=='news'?'color_main':'text-gray'">互帮互助</view>
				</view>
...
<script>
	...
	import discuss from "./discuss.vue";	//校内吐槽
	import news from "./news.vue";	//互帮互助
